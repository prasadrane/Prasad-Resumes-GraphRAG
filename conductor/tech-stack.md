...
- **Serverless Cloud Gateway:** `src/gateway/` package — provider-driven LLM routing (AlibabaProvider, OpenRouterProvider, GeminiProvider) with `_try_chain` failover; `src/query/serverless_gateway.py` is a deprecated re-export shim.
