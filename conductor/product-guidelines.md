...
- **Portability:** Never hardcode user-specific local file paths; use relative path resolution and require explicit CLI flags (e.g., `convert --source`) instead of environment variable defaults.
